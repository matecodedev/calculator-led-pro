...
/**
 * Container for the calculator: owns the state, wires the domain to the panels,
 * and turns a finished calculation into a PDF. The panels below it render.
 */
export default function CalculatorScreen() {
  const draft = useProjectDraft();
  const plan = useRoutingPlan(draft.results);
